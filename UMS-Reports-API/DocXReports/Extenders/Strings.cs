...
namespace DocXReports.Extenders
{
    public static class Strings
    {
        ...
        public static string TrimLeftPadding(this string value, char paddingCharacter = ' ', int maxLength = 0)
        {
            if (value.Length >= maxLength)
                return value;

            string result = new string(paddingCharacter, maxLength) + value;
